...
function sync(auth) {
  ...
  if (config.get('calendarId')) {
    if (config.get('cookie')) {
      // Fetch enriching students calendar using the stored cookie
      axios({
          method: 'POST',
      ...
      .then((data) => {
        if (data.data.IsAuthorized) {
          ...
          // List the events on the user's Google calendar already generated by the script
          ...
          calendar.events.list({
            ...
            // For each enriching students event, either add or update an event on google
